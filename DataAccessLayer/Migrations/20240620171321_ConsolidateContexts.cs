...
{
    /// <inheritdoc />
    public partial class ConsolidateContexts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPremade = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserVocabularySet",
                columns: table => new
                {
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    VocabularySetsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserVocabularySet", x => new { x.UsersId, x.VocabularySetsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserVocabularySet_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserVocabularySet_VocabularySets_VocabularySetsId",
                        column: x => x.VocabularySetsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserVocabularySets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VocabularySetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsPremade", "Name", "UserId" },
                values: new object[,]
                {
                    { 1, true, "Verbs", null },
                    { 2, true, "Places", null }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Lesson 1", null },
                    { 2, true, "Lesson 2", null }
                });

            migrationBuilder.InsertData(
                table: "Words",
                columns: new[] { "Id", "EnglishWord", "JapaneseWord", "VocabularySetId" },
                values: new object[,]
                {
                    { 1, "apple", "りんご", 1 },
                    { 2, "banana", "バナナ", 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserVocabularySet_VocabularySetsId",
                table: "ApplicationUserVocabularySet",
                column: "VocabularySetsId");
